...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    $sql = "SELECT * FROM COURSE where SEM= 3 AND (COURSE_CODE='18CS31' OR COURSE_CODE='18CS32' OR COURSE_CODE='18CS33' OR COURSE_CODE='18CS34' OR COURSE_CODE='18CS35' OR COURSE_CODE='18CS36' OR COURSE_CODE='18CSL37' OR COURSE_CODE='18CSL38')";
    $sql1 = " SELECT COURSE_CODE FROM COURSE where SEM=3 and (COURSE_CODE='18KAK39' OR COURSE_CODE='18CPC39')";
    $sql2 = " SELECT COURSE_NAME FROM COURSE where SEM=3 and (COURSE_CODE='18KAK39' OR COURSE_CODE='18CPC39')";
