...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    $sql = "SELECT * FROM COURSE where SEM= 1 AND (COURSE_CODE='18MAT11' OR COURSE_CODE='18PHY12' OR COURSE_CODE='18ELE13' OR COURSE_CODE='18CIV14' OR COURSE_CODE='18EGDL15' OR COURSE_CODE='18PHYL16' OR COURSE_CODE='18ELEL17')";
    $sql1 = " SELECT COURSE_CODE FROM COURSE where SEM=1 and (COURSE_CODE='18EGH18' OR COURSE_CODE='18EGH28')";
    $sql2 = " SELECT COURSE_NAME FROM COURSE where SEM=1 and (COURSE_CODE='18EGH18' OR COURSE_CODE='18EGH28')";
