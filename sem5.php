...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    $sql = "SELECT * FROM COURSE where SEM=5 AND (COURSE_CODE='18CS51' OR COURSE_CODE='18CS52' OR COURSE_CODE='18CS53' OR COURSE_CODE='18CS54' OR COURSE_CODE='18CS55' OR COURSE_CODE='18CS56' OR COURSE_CODE='18CSL57' OR COURSE_CODE='18CSL58')";
    $sql1 = " SELECT COURSE_CODE FROM COURSE where SEM=5 and (COURSE_CODE='18CIV59' OR COURSE_CODE='18CS60')";
    $sql2 = " SELECT COURSE_NAME FROM COURSE where SEM=5 and (COURSE_CODE='18CIV59' OR COURSE_CODE='18CS60')";
